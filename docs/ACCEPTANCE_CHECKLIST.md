...
Updated: 2026-09-11. Source: music-encyclopedia-q.md §36 plus the user-approved Persian-only launch scope recorded in IMPLEMENTATION_PLAN.md.
...
| 4 | RTL layout | B10 | Persian font, logical layout, keyboard and responsive checks in fa | Unverified |
...
| 13 | Relevant search | B06, B11 | LIKE result/type/paging and deletion visibility passed; ranked FTS path remains B11 | In progress |
...
| 19 | Tests pass | B01–B08, B13 | Local Release suite passes 82 substantive cases; CI/container run remains B13 | In progress |
